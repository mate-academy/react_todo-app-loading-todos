...
- Replace `denis-denis718` with your Github username in the [DEMO LINK](https://denis-denis718.github.io/react_todo-app-loading-todos/) and add it to the PR description.
