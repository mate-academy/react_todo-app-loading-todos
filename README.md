...
3. reate some todos using the [Demo Page](https://mate-academy.github.io/react_todo-app-with-api/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://freelinex.github.io/react_todo-app-loading-todos/) and add it to the PR description.
