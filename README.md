...
> Here is [the working example](https://magf
te-academy.github.io/react_todo-app-with-api/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://spec0s.github.io/react_todo-app-loading-todos/) and add it to the PR description.
