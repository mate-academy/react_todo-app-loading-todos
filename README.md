...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maksymivivan2000-dotcom.github.io/react_todo-app-loading-todos/) and add it to the PR description.
