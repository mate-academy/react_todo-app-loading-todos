...
- Replace `MarianaKlochnyk` with your Github username in the [DEMO LINK](https://MarianaKlochnyk.github.io/react_todo-app-loading-todos/) and add it to the PR description.
