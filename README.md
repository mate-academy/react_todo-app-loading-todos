...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Yura-Soroka.github.io/react_todo-app-loading-todos/) and add it to the PR description.
