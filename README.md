...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://KristinaTar.github.io/react_todo-app-add-and-delete/) and add it to the PR description.
