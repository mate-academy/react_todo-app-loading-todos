# React TodoElement App Load Todos

You goal is to implement a simple TodoElement App that will save all changes to [the API](https://mate-academy.github.io/fe-students-api/).
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://MykolaFatkullin.github.io/react_todo-app-loading-todos/) and add it to the PR description.
