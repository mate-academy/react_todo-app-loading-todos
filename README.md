...
- Replace `<your_account>` with your Github username in the  and add it to the PR description.[DEMO LINK](https://victoria-kovalenko.github.io/react_todo-app-loading-todos/)
