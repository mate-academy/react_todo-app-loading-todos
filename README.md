...
- Replace `AntonBelia` with your Github username in the [DEMO LINK](https://AntonBelia.github.io/react_todo-app-loading-todos/) and add it to the PR description.
