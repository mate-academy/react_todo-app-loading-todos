...
- Replace `Viktoria-Moroz` with your Github username in the [DEMO LINK](https://Viktoria-Moroz.github.io/react_todo-app-loading-todos/) and add it to the PR description.
