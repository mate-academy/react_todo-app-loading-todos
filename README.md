...
- Replace `Valentyna08` with your Github username in the [DEMO LINK](https://Valentyna08.github.io/react_todo-app-loading-todos/) and add it to the PR description.
