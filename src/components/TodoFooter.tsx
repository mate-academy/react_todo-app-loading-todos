...
export const TodoFooter: React.FC<Props> = ({ todos, filterField, filterBy }) => {
  ...
  return (
    <footer className="todoapp__footer" data-cy="Footer">
      ...
      <nav className="filter" data-cy="Filter">
        ...
        <a
          href="#/completed"
          className={cn('filter__link', {selected: filterField === 'completed'})}
      ...
      <button
        ...
        disabled={todosCounter === todos.length || todos.length === 0}
      >
        Clear completed
      </button>
    </footer>
