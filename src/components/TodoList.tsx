    ...
    <section className="todoapp__main" data-cy="TodoList">
      ...
      {isNotCompletedTodoVisible && (
        <div data-cy="Todo" className="todo">
          <label
            className="todo__status-label"
            htmlFor="isNotCompletedTodoVisible"
          >
            <input
              id="isNotCompletedTodoVisible"
              data-cy="TodoStatus"
              type="checkbox"
              className="todo__status"
            />
      ...
      {isEditingTodoVisible && (
        <div data-cy="Todo" className="todo">
          <label className="todo__status-label" htmlFor="isEditingTodoVisible">
            <input
              id="isEditingTodoVisible"
              data-cy="TodoStatus"
              type="checkbox"
              className="todo__status"
            />
      ...
      {isLoadingTodoVisible && (
        <div data-cy="Todo" className="todo">
          <label className="todo__status-label" htmlFor="isLoadingTodoVisible">
            <input
              id="isLoadingTodoVisible"
              data-cy="TodoStatus"
              type="checkbox"
              className="todo__status"
            />
