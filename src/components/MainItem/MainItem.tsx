import type { MainitemType } from '../../types/MainitemType';
        ...
        >
          ...
          <label className="todo__status-label">
            <input
              ...
              onChange={() => onUpdate({ ...shownTodos, completed: !shownTodos.completed })}
            />
          </label>
          ...
          {editFieldVal === shownTodos.id && (
            <input
              ...
              value={editInputVal}
              onChange={e => { onEditInputVal(e.target.value); }}
              onBlur={async () => { await onEditHandle(shownTodos); }}
          ...
          {editFieldVal !== shownTodos.id && (
            <span
              ...
              onDoubleClick={() => {
                ...
                onEditInputVal(shownTodos.title);
              }}
            >
              {shownTodos.title}
            </span>
          ...
          <button
            ...
            data-cy="TodoDelete"
            onClick={async () => { await deleteTodoFromList(); }}
          >
            ×
          </button>
          <div
