...
import { USER_ID, getTodos, Todo } from './api/todos';

type FilterStatus = 'all' | 'active' | 'completed';

const ERROR_MESSAGES = {
  load: 'Unable to load todos',
  // poniższe przydadzą się w kolejnych częściach:
...
export const App: React.FC = () => {
  ...
  // 1) Filter z URL hash (#/, #/active, #/completed)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    setError(''); // hide notification before request
    setIsLoading(true);
  ...
  return (
    <div className="todoapp">
      ...
      <div className="todoapp__content">
        ...
        {/* Hide the list if there are no todos yet */}
        {hasTodos && (
