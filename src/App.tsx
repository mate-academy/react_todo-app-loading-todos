...
import { Filter, Errors } from './types/enums';
...
export const App: React.FC = () => {
  ...
  const getFilteredTodos = (tody: Todo[], query: string): Todo[] => {
    let filteredTodo = [...tody];
  ...
  const filteredTodo = getFilteredTodos(todos, filterMethod);
