...
{
  /*  00This todo is an active todo00
          ...
          00 This todo is being edited00
          <div data-cy="Todo" className="todo">
            <label className="todo__status-label">
              <input
                data-cy="TodoStatus"
             ...
             00This form is shown instead of the title and remove button00
           ...
           00This todo is in loadind state00
          <div data-cy="Todo" className="todo">
            <label className="todo__status-label">
              <input
                data-cy="TodoStatus"
            ...
            <button type="button" className="todo__remove" data-cy="TodoDelete">
             ...
             00'is-active' class puts this modal on top of the todo 00
